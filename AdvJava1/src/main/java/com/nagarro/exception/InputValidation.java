...
public class InputValidation {
	...
	public boolean isInputValid(String size, String gender, int ouputPrefer) {
		...
		try {
			return isProductSizeValid(size) && isCustomerGenderValid(gender) && isOuputPreferValid(ouputPrefer);
	...
	public boolean isProductSizeValid(String size) throws InvalidInputException {
	...
	public boolean isCustomerGenderValid(String gender) throws InvalidInputException {
